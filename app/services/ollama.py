...
class OllamaService(BaseService):
    ...
    async def pull_model(self, model_name: str = 'deepseek-r1:1.5b'):
        payload = {
            'model': model_name,
            'stream': False,
            'format': 'json'
    ...
    async def fetch_model(self, prompt: str, paylaod: dict = DEFAULT_MODEL_METADATA) -> dict:
    ...
    async def extract_ruts_from_pdf(
        self,
...
if __name__ == "__main__":
    asyncio.run(OllamaService().ollama_generate_endpoint())
